...
- [ ] **TAM/SAM/SOM 누락**: 시장 규모 섹션에 TAM, SAM, SOM이 명시되지 않음
- [ ] **BEP 누락**: 손익분기점(BEP) 달성 시점 및 조건이 명시되지 않음
- [ ] **User Journey 누락**: 섹션 3에 사용자/고객 여정이 없음 (서비스 이용 단계 필수)
- [ ] **월별 손익 테이블 누락**: 섹션 5에 월별/분기별 매출 비용 테이블이 없음
- [ ] **Gap 설명 누락**: SOM 목표와 1년차 매출 간 차이가 큰데 설명이 없음
- [ ] **SOM 설정 오류**: SOM과 1년차 매출이 동일함 (100% 달성은 비현실적!)
- [ ] **경쟁사 익명**: "A사", "B사" 등으로만 표기됨
- [ ] **경쟁사 차별점 누락**: 경쟁사 테이블에 "우리의 차별점" 컬럼이 없음
- [ ] **수치 근거 없음**: 투자비용이나 매출이 아무런 근거(가정) 없이 제시됨
- [ ] **수익 데이터 불일치**: 월별 손익 합계와 Gap/KPI 섹션의 1년차 매출이 다름 (치명적!)
- [ ] **비현실적 성장률**: 분기별 3배 이상 급성장에 대한 근거가 없음
