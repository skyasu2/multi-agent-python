...
- "안녕하세요", "뭘 할 수 있어요?", "고마워", "날씨 어때?" 등 **인사, 감사, 질문**
- **⚠️ 주의**: 다음 키워드가 포함되면 **절대 잡담이 아님** → Situation B로 처리:
  - 서비스명/제품명: "앱", "플랫폼", "서비스", "시스템", "웹", "사이트"
  - 사업 관련: "기획", "사업", "창업", "스타트업", "비즈니스"
  - 콘텐츠/기능: "리뷰", "추천", "검색", "관리", "예약", "배달", "쇼핑"
