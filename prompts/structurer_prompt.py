...
1. **최소 {min_sections}개 이상의 섹션을 포함**하여 구조를 설계하세요:
   - 기획서의 완성도를 위해 충분한 깊이와 넓이를 확보해야 합니다.
   - 아래 표준 섹션들을 기본으로 포함하되, 필요시 세분화하거나 추가하세요:

2. **핵심 기능 및 주요 특징**:
   - 반드시 **최소 {min_key_features}개 이상**의 구체적인 핵심 기능이나 차별화 포인트를 정의하세요.
   - 단순 나열이 아닌, 각 기능의 핵심 가치가 드러나도록 구성하세요.
   - 프로젝트 개요
   - 문제 정의 및 해결책
