...
⚠️ **이 섹션은 절대 생략 불가!** SOM과 1년차 매출이 다르면 반드시 설명해야 함.

- **SOM 목표**: [X억원]
- **1년차 예상 매출**: [Y억원]
- **달성률**: [Y/X × 100]% (예: "1년차 달성률 10.8%")
- **Gap 극복 전략**:
   - 2년차: [구체적 성장 전략] → 달성률 [N]%
   - 3년차: [시장 확대/신규 BM] → 달성률 [M]%
   - 투자 유치 계획: [시리즈 A/B 예상 시점 및 금액]

✅ 예시:
"SOM 50억 원 대비 1년차 예상 매출 5억 원 (달성률 10%).
2년차에는 마케팅 확대로 2배 성장(10억 원, 20%),
3년차에는 B2B 확장으로 15억 원(30%) 달성 목표.
시리즈 A(20억 원)를 2년차에 유치하여 성장 가속화."
```
