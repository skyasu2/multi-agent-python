...
### 시장 규모 (⚠️ 글로벌 N% 단순 추정 절대 금지!)
- **TAM**: [글로벌 전체 시장] (출처: XXX 리서치)
- **SAM**: [국내 실제 접근 가능 시장] 
   ⚠️ **필수 검증**: "글로벌의 20%" 같은 감으로 추정 금지!
   ✅ **권장**: 국내 점유율 Top 3 기업 시총 합계, 통계청 자료, 협회 발표 등 활용
   ✅ 예시: "국내 SAM $10억 (글로벌의 7%) - 근거: 당근마켓 기업가치 $3B 참고"
- **SOM**: [초기 목표 시장] → 1년차 목표 (근거: SAM의 X% 점유)
```
...
⚠️ **필수**: 당근마켓(MAU 1800만), 네이버 등 기존 강자가 있으면 **경쟁 리스크**를 반드시 명시하고, 
   "정면 경쟁 회피 → 니치 시장(이벤트/봉사/특수 커뮤니티) 집중" 같은 우회 전략을 제시하세요.
```
